...
reported through the repository's private
[reporting form](https://github.com/antonsmedberg/MetalVisualKit/security/advisories/new).
Start the report title with `Conduct report:` so it can be handled separately
from security reports. Do not open a public issue for a conduct report. All
